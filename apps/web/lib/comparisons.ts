...
const createNextApp: Comparison = {
  ...
  faq: [
    ...
    { q: 'When is create-next-app the better choice?', a: 'When you are building something that is not a website — a dashboard, an internal tool, a novel app — and you want zero opinions in the repo; blank is a feature there. And a one-off page that needs neither design nor discovery — create-next-app is as fast to an empty route.' },
