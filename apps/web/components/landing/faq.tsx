  ...
  },
  {
    ...
    a: (
      <>
        ...
        site and lands pages and posts as drafts you review (<code>siteImport</code> flag, Firecrawl key;
        services land in an admin table with no public page today — reclassify them as pages). <strong>From WooCommerce:</strong> product CSV import (simple products) plus the URL import
