...
2. Export the canonical design.md for sharing:
   ```bash
   tsx scripts/design-export.ts my-design > my-design.md  # coming in v0.7.1
   ```
3. Share the `.md` file with others — they drop it in `/admin/designs` and get your exact design

(Coming soon: a community design marketplace at cartwright.app where you can browse and install community-uploaded designs with one command.)
