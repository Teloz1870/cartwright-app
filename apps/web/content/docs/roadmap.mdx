...
- **Shopify migration with Plus** `[shipping Q3 2026]` — agentic five-step migration: scrape source URL, map products + customers + brand palette, deploy. Live preview already at [/onboarding](/onboarding). The agent ships with Plus; manual scripts remain available for self-hosted forks.
