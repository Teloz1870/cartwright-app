...
Where it lives: the Vibe Sandbox at `/admin/vibe-sandbox`, with v0 selectable as the second engine beside the paste box; the output lands through the same sanitiser as any other vibe push.
