...
| Endpoint | Purpose |
|---|---|
| `POST /api/admin/vibe/generate` | Server-side generation via the configured AI provider (Anthropic by default; Ollama if `aiProvider = "local"`). Returns sanitised HTML. |
