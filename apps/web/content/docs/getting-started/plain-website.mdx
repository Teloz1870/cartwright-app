...
They are followed by the CLI's shared epilogue (a CI-workflow note, GitHub/Vercel lines written for the shop profile, and a Quick Start link) — that epilogue becomes profile-aware in the CLI's next release; the five lines above are the ones that apply.
