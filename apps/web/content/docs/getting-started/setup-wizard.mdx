...
<Callout type="info">
You must be **signed in as admin** to reach the wizard — it's behind the admin auth gate. New here? [Sign in for the first time](/docs/getting-started/first-login) covers creating the admin and finding your password.
</Callout>
