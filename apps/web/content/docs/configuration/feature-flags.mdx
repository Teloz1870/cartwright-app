...
| `acpCheckout` | `true` | Agentic Commerce Protocol: If enabled, AI agents (acting via ACP) can construct an order flow and request checkout creation via `/api/v1/checkout/create`. |
