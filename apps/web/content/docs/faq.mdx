...
- **Self-hosted ($0).** Full template. You bring your own Vercel, database, Stripe, email, and AI keys. Community support via Discord and GitHub Issues. Every feature inside the template is available — nothing is paywalled.
