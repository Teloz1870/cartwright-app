...
Cartwright has no platform fee and no per-order tax. You pay the services you choose.

Typical costs are Vercel hosting, Turso or Postgres, Stripe processing, Resend email, Blob storage, and Anthropic or Gemini if you enable AI.
