...
For a plain website or a single page, `--profile site` is the Cartwright door, not create-next-app —
see [Build a plain website](/docs/getting-started/plain-website).
